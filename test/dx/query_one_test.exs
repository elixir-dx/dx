defmodule Dx.QueryOneTest do
  ...
  describe "query_one" do
    test "returns single calendar_override", %{
      ...
      assert Dx.load!(task, :calendar_override, extra_rules: Rules) ==
               expected
    ...
    test "returns multiple calendar_overrides in one ecto query", %{
      ...
      assert Dx.load!(tasks, :calendar_override, extra_rules: Rules) ==
               expected
  ...
  describe "query_first" do
    test "returns single calendar_override", %{
      ...
      assert Dx.load!(task, :first_calendar_override, extra_rules: Rules) ==
               expected
    ...
    test "returns multiple calendar_overrides in one ecto query", %{
      ...
      assert Dx.load!(tasks, :first_calendar_override, extra_rules: Rules) ==
               expected
  ...
  describe "query_all" do
    test "returns single calendar_override", %{
      ...
      assert Dx.load!(task, :calendar_overrides, extra_rules: Rules) ==
               expected
    ...
    test "returns multiple calendar_overrides in one ecto query", %{
      ...
      assert Dx.load!(tasks, :calendar_overrides, extra_rules: Rules) ==
               expected
